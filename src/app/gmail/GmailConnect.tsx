    ...
    return (
      <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4 mb-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="font-medium text-blue-900 dark:text-blue-100">Loading Gmail...</h3>
            <p className="text-sm text-blue-700 dark:text-blue-300">Fetching your emails</p>
          </div>
        </div>
      </div>
    );
      ...
      <div className="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg p-4 mb-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="font-medium text-green-900 dark:text-green-100">Connected to Gmail</h3>
              <p className="text-sm text-green-700 dark:text-green-300">Your emails are synced</p>
            </div>
          </div>
