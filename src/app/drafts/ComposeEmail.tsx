...
export function ComposeEmail({ draftId, inline = false }: ComposeEmailProps) {
  ...
  const RecipientInput = ({ field, label }: { field: 'to' | 'cc' | 'bcc'; label: string }) => {
    ...
    <div className={wrapperClass}>
      ...
      <div className="flex items-center justify-between px-4 py-3 bg-gray-50 dark:bg-gray-800 rounded-t-lg">
        ...
        <div className="flex items-center gap-1">
          {!inline && (
            <button
              onClick={() => updateComposeDraft(draftId, { isMinimized: !draft.isMinimized })}
        ...
        <>
          ...
          <div className="border-b border-gray-200 dark:border-gray-700 px-4 py-2">
            <input
              ...
              onChange={(e) => updateComposeDraftData(draftId, { subject: e.target.value })}
              placeholder="Subject"
          ...
          <div className={`flex-1 p-4 ${inline ? 'min-h-[200px]' : ''}`}>
            <textarea
              ...
              onChange={(e) => updateComposeDraftData(draftId, { body: e.target.value })}
